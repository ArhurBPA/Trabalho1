...
int main()
{
    FILE *entrada = fopen("C:/Users/arthu/OneDrive/Documentos/Codigos/Trabalho1/DadosEntrada.csv", "r");
    FILE *saida = fopen("C:/Users/arthu/OneDrive/Documentos/Codigos/Trabalho1/NotaFinal.csv", "w");
